...
#                 return redirect('myapp:predict')  # Redirect to predict after successful login
...
#     return render(request, 'myapp/predict.html')  # Render the predict page if no POST data
